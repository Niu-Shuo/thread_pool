 ...
 * @Version: 
 * @Author: Niu Shuo
 * @Date: 2024-06-14 16:02:25
 * @LastEditors: Niu Shuo
 * @LastEditTime: 2024-07-03 20:29:17
 */
#include <assert.h>
...
//             return;
//         }
//         response->set_order_id("20210614");
...
//     auto addr = std::make_shared<netrpc::IPNetAddr>("127.0.0.1", netrpc::Config::GetInst().m_port);
