 ...
 * @Version: 
 * @Author: Niu Shuo
 * @Date: 2024-06-14 15:36:09
 * @LastEditors: Niu Shuo
 * @LastEditTime: 2024-07-03 21:20:16
 */
#include <assert.h>
...
//     auto closure = std::make_shared<netrpc::RpcClosure>(nullptr, [request, response, channel, controller]() mutable {
