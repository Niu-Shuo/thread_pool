 ...
 * @Version: 
 * @Author: Niu Shuo
 * @Date: 2024-06-14 15:30:00
 * @LastEditors: Niu Shuo
 * @LastEditTime: 2024-06-14 15:35:47
 */
#include <pthread.h>
...
void test_io_thread() {
    ...
    */
    ...
    auto timer_event = std::make_shared<netrpc::TimerEvent>(2000, true, [&ii]() {
        INFOLOG("trigger timer event, count=%d", ii++);
    });
